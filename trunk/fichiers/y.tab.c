...
static const char *const yytname[] =
{
  ...
  "')'", "$accept", "lignecommande", "expression", "fichier", "commande", YY_NULLPTR
};
#endif
...
#line 106 "Analyse.y" /* yacc.c:1906  */
